...
INSERT INTO `custom_kpi` VALUES (1,'Экономическая добавленная стоимость','Прирост капитализации.','eva','(NP / IC – WACC) * IC = (ROI – WACC) * IC','http://finanalis.ru/litra/324/2293.html',2,2,0,3),(2,'Прибыль до уплаты процентов, налогов и начисленной амортизации','','ebidta','Доход – Расходы (без процентов и налогов) + Амортизация','',2,2,0,3),(3,'Доля рынка','','ms','','',0,1,1,0);
...
INSERT INTO `kpi_target_values` VALUES (1,'ms',5556,0,0,0,'2015-11-07 17:06:46'),(2,'eva',11,11,4,0,'2015-11-07 16:38:39'),(3,'ebidta',33,33,4,0,'2015-11-07 16:44:52');
...
-- Dump completed on 2015-11-07 17:13:52
