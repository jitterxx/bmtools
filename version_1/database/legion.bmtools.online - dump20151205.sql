CREATE DATABASE  IF NOT EXISTS `mklegion` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `mklegion`;
-- MySQL dump 10.13  Distrib 5.5.46, for debian-linux-gnu (x86_64)
--
-- Host: 127.0.0.1    Database: mklegion
-- ------------------------------------------------------
...
INSERT INTO `custom_kpi` VALUES (1,'Прибыль до уплаты процентов, налогов и начисленной амортизации','','ebidta','Доход – Расходы (без процентов и налогов) + Амортизация','',0,0,0,1,' ',0),(2,'Доля рынка','','ms','','',2,1,2,3,' ',0),(3,'Показатель для подразделения 1','Создан самостоятельно','5fg045','not defined','',0,0,0,0,' ',0),(6,'Экономическая добавленная стоимость','Прирост капитализации.','eva','(NP / IC – WACC) * IC = (ROI – WACC) * IC','http://finanalis.ru/litra/324/2293.html',0,0,0,0,' ',0),(7,'Средневзвешенная цена капитала','(Собственный капитал / Инвестированный капитал) * Ожидаемая доходность от собственного капитала + (Заемные средства / Инвестированный капитал) * Ожидаемая доходность от заёмных средств * (1 – Ставка налога на прибыль для компании)','wacc','(Собственный капитал / Инвестированный капитал) * Ожидаемая доходность от собственного капитала + (Заемные средства / Инвестированный капитал) * Ожидаемая доходность от заёмных средств * (1 – Ставка налога на прибыль для компании)','',0,0,0,0,' ',0);
...
INSERT INTO `kpi_target_values` VALUES (1,'ms',100,200,0,'2015-11-12 18:33:14',1);
...
INSERT INTO `strategic_maps_desc` VALUES (1,'ent0','Стратегическая карта компании','Стратегическая карта компании верхнего уровня.',0,0,'2015-11-07 00:52:39',0,'{\"g3\":{\"left\":52,\"top\":137},\"g1\":{\"left\":236,\"top\":8},\"dg3ab2\":{\"left\":293,\"top\":105},\"dg4ce9\":{\"left\":642,\"top\":11},\"dg3463\":{\"left\":451,\"top\":54},\"dg7cd3\":{\"left\":19,\"top\":18},\"dg2f2c\":{\"left\":265,\"top\":244},\"dg80e4\":{\"left\":311,\"top\":329},\"dg1f44\":{\"left\":447,\"top\":314},\"dgc9a2\":{\"left\":411,\"top\":212},\"dg4acb\":{\"left\":587,\"top\":292},\"dgce95\":{\"left\":78,\"top\":477},\"dg56a7\":{\"left\":232,\"top\":481},\"dg448b\":{\"left\":375,\"top\":478},\"dg4a64\":{\"left\":586,\"top\":211},\"dg4f4c\":{\"left\":342,\"top\":475},\"dg462d\":{\"left\":71,\"top\":651},\"dg4fd6\":{\"left\":670,\"top\":471},\"dgb154\":{\"left\":668,\"top\":471},\"dg9d4b\":{\"left\":27,\"top\":518},\"dgf52d\":{\"left\":515,\"top\":433},\"dgc59b\":{\"left\":158,\"top\":320},\"dg21cd\":{\"left\":280,\"top\":406},\"dg164f\":{\"left\":365,\"top\":629},\"dg8f33\":{\"left\":100,\"top\":432}}'),(5,'dep7','Стратегическая карта: Производство','',2,0,'2015-11-18 18:23:58',7,'{\"g3\":{\"left\":59,\"top\":150},\"dg0a4d\":{\"left\":213,\"top\":158},\"g1\":{\"left\":68,\"top\":28}}'),(6,'dep9','Стратегическая карта: Логистика','',2,0,'2015-11-18 18:24:20',9,NULL);
...
-- Dump completed on 2015-12-05 22:23:07
